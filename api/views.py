...
def data_getOpportunities(request):
	...
	currentArray.append('LACC History');
	currentArray.append('U T C Sprint');
	currentArray.append('Gate of Heaven');
	currentArray.append('Bolinas Banner');
	currentArray.append('Best of Shonin');
	currentArray.append('Scotts Valley');
	currentArray.append('Bakersfield');
	currentArray.append('Estrada Courts Mural Run');
	currentArray.append('Capture IRP');
	currentArray.append('No Evil Monkeys');
	currentArray.append('Promenade Takeover');
	currentArray.append('The Force Awakens Suisun Pt');
	currentArray.append('Tribute to Mission Day Oakland');
	currentArray.append('Oakland Chinatown');
	currentArray.append('Celebrating Fireworks in Lake Tahoe');
	currentArray.append('Founding Sonoma');
	currentArray.append('SBCC Campus Tour');
	currentArray.append('Pepperdine Waves');
	currentArray.append('King of the Campus');
	currentArray.append('King Of The Downey Farm');
	currentArray.append('Las Gatos Memorial Park Stroll');
	currentArray.append('ENL Hayward');
	currentArray.append('Historic Chico Cemetery');
	currentArray.append('A Walk Around the Block');
	currentArray.append('HB Historic');
	currentArray.append('Visit the town of COLFAX');
	currentArray.append('Emeryville Banner');
	currentArray.append('Excelsior San Francisco');
	currentArray.append('Webster Tour');
	currentArray.append('SF Bart Rapid Transit Car');
	currentArray.append('Joe Philley Tribute Series');
	currentArray.append('Resistance is Inevitable');
	currentArray.append('Albany Bulb Art and Nature Walk');
	currentArray.append('Aptos Skyline');
	currentArray.append('Bike Trooper Series');
	currentArray.append('Bro San Francisco');
	currentArray.append('Doyle Hollis');
	currentArray.append('Googleplex');
	currentArray.append('SF Botanical Garden');
	currentArray.append('GIANTS');
	currentArray.append('Glyph Master Oakland');
	currentArray.append('JLS Build-A-Rainbow');
	currentArray.append('View from the Top');
	currentArray.append('Learn Your Glyph-tionary Word - Brentwood');
	currentArray.append('Learn Your Glyph-tionary Word - Livermore');
	currentArray.append('Make Your Choice  Seaside');
	...
	for item in currentArray:
		...
		results = Mosaic.object.filter(title=item)
		if results.count() < 1:
