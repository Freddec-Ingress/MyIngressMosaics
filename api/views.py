...
def data_getOpportunities(request):
	...
	currentArray.append({'name':'Resist (1 of 7)', 'link':'/mosaic/18254', 'city':'Hayward'});
	currentArray.append({'name':'Earn the Seven Power Coins - CA', 'link':'/mosaic/19658', 'city':'San Fernando'});
	currentArray.append({'name':'San Pedro mini series', 'link':'/mosaic/15147', 'city':'Los Angeles'});
	currentArray.append({'name':'Woodland Movie in Old Town', 'link':'/mosaic/20948', 'city':'Woodland'});
	currentArray.append({'name':'Oakland Zoo', 'link':'/mosaic/22257', 'city':'Oakland'});
	currentArray.append({'name':'Maths', 'link':'/mosaic/7033', 'city':'Los Angeles'});
	currentArray.append({'name':'The Animal Kingdom', 'link':'/mosaic/23078', 'city':'Lake Forest'});
	currentArray.append({'name':'SF Cable Car Powell-Hyde', 'link':'/mosaic/3373', 'city':'San Francisco'});
	currentArray.append({'name':'SF Historic Streetcar #1061', 'link':'/mosaic/3376', 'city':'San Francisco'});
	currentArray.append({'name':'GGB San Francisco', 'link':'/mosaic/3415', 'city':'San Francisco'});
	currentArray.append({'name':'Lake Merritt Walk', 'link':'/mosaic/3442', 'city':'Oakland'});
	currentArray.append({'name':'Love Lafayette', 'link':'/mosaic/3448', 'city':'Lafayette'});
	currentArray.append({'name':'Pacific Grove Mosaic', 'link':'/mosaic/3456', 'city':'Monterey'});
	currentArray.append({'name':'San Francisco s Pyramid', 'link':'/mosaic/3463', 'city':'San Francisco'});
	currentArray.append({'name':'Tour of Downtown Brentwood', 'link':'/mosaic/3473', 'city':'Brentwood'});
	currentArray.append({'name':'Visit Modesto Banner', 'link':'/mosaic/3479', 'city':'Modesto'});
	currentArray.append({'name':'Winter Rose Mosaic', 'link':'/mosaic/3588', 'city':'Escondido'});
	currentArray.append({'name':'Chico  CA - mosaic', 'link':'/mosaic/3589', 'city':'Chico'});
	currentArray.append({'name':'Clovis', 'link':'/mosaic/3908', 'city':'Clovis'});
	currentArray.append({'name':'Los Angeles Skyline', 'link':'/mosaic/4993', 'city':'Los Angeles'});
	currentArray.append({'name':'Explore Thousand Oaks', 'link':'/mosaic/5918', 'city':'Thousand Oaks'});
	currentArray.append({'name':'Bixby Bridge - Clouds (add-on)', 'link':'/mosaic/5949', 'city':'Carmel-by-the-Sea'});
	currentArray.append({'name':'Menifee Tour', 'link':'/mosaic/5965', 'city':'Menifee'});
	currentArray.append({'name':'I frack in your general direction', 'link':'/mosaic/5973', 'city':'Oakland'});
	currentArray.append({'name':'Fresno', 'link':'/mosaic/6370', 'city':'Fresno'});
	currentArray.append({'name':'DCA Disney California Adventure', 'link':'/mosaic/6678', 'city':'Anaheim'});
	currentArray.append({'name':'All Aboard  Next Stop Mainstreet USA  DL01', 'link':'/mosaic/6679', 'city':'Anaheim'});
	currentArray.append({'name':'DL Disneyland', 'link':'/mosaic/6680', 'city':'Anaheim'});
	currentArray.append({'name':'Belmont Park Mural', 'link':'/mosaic/6681', 'city':'San Diego'});
	currentArray.append({'name':'OC Resistance', 'link':'/mosaic/6788', 'city':'Costa Mesa'});
	currentArray.append({'name':'San Mateo-Hayward Bridge', 'link':'/mosaic/6808', 'city':'San Mateo'});
	currentArray.append({'name':'SF Zoo Mission', 'link':'/mosaic/6815', 'city':'San Francisco'});
	currentArray.append({'name':'Frank Lloyd Wright', 'link':'/mosaic/6973', 'city':'San Rafael'});
	currentArray.append({'name':'Downtown Visalia', 'link':'/mosaic/7511', 'city':'Visalia'});
	currentArray.append({'name':'Edwards AFB Exploration', 'link':'/mosaic/7583', 'city':'Edwards Air Force Base'});
	currentArray.append({'name':'Explore the Saddleback Valley', 'link':'/mosaic/7723', 'city':'San Juan Capistrano'});
	currentArray.append({'name':'San Pedro Waterfront', 'link':'/mosaic/9003', 'city':'Los Angeles'});
	currentArray.append({'name':'Explore Lakeside', 'link':'/mosaic/9064', 'city':'El Cajon'});
	currentArray.append({'name':'Flight Test Explorers', 'link':'/mosaic/9090', 'city':'0'});
	currentArray.append({'name':'Castle Air Museum B52 banner', 'link':'/mosaic/9752', 'city':'Atwater'});
	currentArray.append({'name':'SF S200 LRV Introduction', 'link':'/mosaic/9803', 'city':'San Francisco'});
	currentArray.append({'name':'Old Town Eureka', 'link':'/mosaic/9811', 'city':'Eureka'});
	currentArray.append({'name':'Third Ave   Chula Vista Mural', 'link':'/mosaic/10124', 'city':'Chula Vista'});
	currentArray.append({'name':'Signal Hill', 'link':'/mosaic/10162', 'city':'Signal Hill'});
	currentArray.append({'name':'Tour Old Sacramento', 'link':'/mosaic/10479', 'city':'Sacramento'});
	currentArray.append({'name':'sddave s excellent adventure', 'link':'/mosaic/11542', 'city':'San Diego'});
	currentArray.append({'name':'Fortuna Depot Museum', 'link':'/mosaic/12413', 'city':'Fortuna'});
	currentArray.append({'name':'Historic Sixth Street Viaduct', 'link':'/mosaic/12605', 'city':'Los Angeles'});
	currentArray.append({'name':'La Habra Bengal', 'link':'/mosaic/12978', 'city':'La Habra'});
	currentArray.append({'name':'Divisadero tour', 'link':'/mosaic/13215', 'city':'San Francisco'});
	currentArray.append({'name':'Mariner s Mural', 'link':'/mosaic/13861', 'city':'Irvine'});
	currentArray.append({'name':'Santa Clara University', 'link':'/mosaic/13865', 'city':'Santa Clara'});
	currentArray.append({'name':'Los Gatos', 'link':'/mosaic/14321', 'city':'Los Gatos'});
	currentArray.append({'name':'805 X-Faction Series', 'link':'/mosaic/14791', 'city':'Port Hueneme'});
	currentArray.append({'name':'Willow Glen Charm', 'link':'/mosaic/17230', 'city':'San Jose'});
	currentArray.append({'name':'South Park Mural', 'link':'/mosaic/17415', 'city':'San Diego'});
	currentArray.append({'name':'Doctors', 'link':'/mosaic/17889', 'city':'San Francisco'});
	currentArray.append({'name':'The San Gabriel Mission', 'link':'/mosaic/18119', 'city':'San Gabriel'});
	currentArray.append({'name':'California Theatre', 'link':'/mosaic/18566', 'city':'Pittsburg'});
	currentArray.append({'name':'City of Goleta series', 'link':'/mosaic/18587', 'city':'Goleta'});
	currentArray.append({'name':'Explore this area Uno', 'link':'/mosaic/18616', 'city':'San Juan Capistrano'});
	currentArray.append({'name':'Upper Paramount Iceland', 'link':'/mosaic/18985', 'city':'Paramount'});
	currentArray.append({'name':'Visit Bugs Land and Cars Land', 'link':'/mosaic/19196', 'city':'Anaheim'});
	currentArray.append({'name':'UCLA Bruins Pride', 'link':'/mosaic/19474', 'city':'Los Angeles'});
	currentArray.append({'name':'Welcome to Night Vale', 'link':'/mosaic/19778', 'city':'Campbell'});
	currentArray.append({'name':'Queen Mary Tour', 'link':'/mosaic/19783', 'city':'Long Beach'});
	currentArray.append({'name':'Assault on Hill 88', 'link':'/mosaic/20864', 'city':'Sausalito'});
	currentArray.append({'name':'Honor our Veterans IngressFS', 'link':'/mosaic/21227', 'city':'San Diego'});
	currentArray.append({'name':'Defend the Downey Farm', 'link':'/mosaic/22407', 'city':'Downey'});
	currentArray.append({'name':'Carpinteria Beach', 'link':'/mosaic/22526', 'city':'Carpinteria'});
	currentArray.append({'name':'Anaheim Hills Scenic Route (AugustPhoebe)', 'link':'/mosaic/23094', 'city':'Anaheim'});
	currentArray.append({'name':'Enlightened Strike Series 1', 'link':'/mosaic/23616', 'city':'Cypress'});
	currentArray.append({'name':'Adam West Tribute', 'link':'/mosaic/23789', 'city':'Garden Grove'});
