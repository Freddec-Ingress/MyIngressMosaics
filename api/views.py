...
def data_getOpportunities(request):
	...
	currentArray.append({'name':'Explore Jordan', 'link':'/mosaic/206', 'city':'Jordan'});
	currentArray.append({'name':'Conquer Belle Plaine', 'link':'/mosaic/3754', 'city':'Belle Plaine'});
	currentArray.append({'name':'Heimatfest Celebration 2016', 'link':'/mosaic/16364', 'city':'Jordan'});
	currentArray.append({'name':'The Big Yellow Barn', 'link':'/mosaic/17079', 'city':'Jordan'});
	currentArray.append({'name':'Wabasha  Minnesota', 'link':'/mosaic/17705', 'city':'Wabasha'});
	currentArray.append({'name':'Lake City Minnesota', 'link':'/mosaic/17710', 'city':'Lake City'});
	currentArray.append({'name':'City of Le Sueur', 'link':'/mosaic/18907', 'city':'Le Sueur'});
	currentArray.append({'name':'French Regional Park - Hike (Beginner)', 'link':'/mosaic/20144', 'city':'Minneapolis'});	
	currentArray.append({'name':'Broadway Boogie', 'link':'/mosaic/3704', 'city':'Minneapolis'});
	currentArray.append({'name':'Cardinal Country', 'link':'/mosaic/19866', 'city':'Alexandria'});
	currentArray.append({'name':'1A-Noonan Park', 'link':'/mosaic/20040', 'city':'Alexandria'});
	currentArray.append({'name':'Full Sculpture Garden', 'link':'/mosaic/20693', 'city':'Minneapolis'});
	currentArray.append({'name':'Stillwater Historic Staircases', 'link':'/mosaic/19923', 'city':'Stillwater'});
	currentArray.append({'name':'SMSU Mosaic', 'link':'/mosaic/649', 'city':'Marshall'});
	currentArray.append({'name':'Soldier s Field Mission Art', 'link':'/mosaic/3290', 'city':'Rochester'});
	currentArray.append({'name':'Faribault', 'link':'/mosaic/3292', 'city':'Faribault'});
	currentArray.append({'name':'Poetry in Motion  SOTR Edition', 'link':'/mosaic/3295', 'city':'Burnsville'});
	currentArray.append({'name':'Rosemount Mural', 'link':'/mosaic/3297', 'city':'Rosemount'});
	currentArray.append({'name':'Poetry in Motion  494-Strip Edition', 'link':'/mosaic/3298', 'city':'Minneapolis'});
	currentArray.append({'name':'Poetry in Motion  Lake Minnetonka Edition', 'link':'/mosaic/3299', 'city':'Minnetonka'});
	currentArray.append({'name':'Poetry in Motion  NW Edition', 'link':'/mosaic/3300', 'city':'Minneapolis'});
	currentArray.append({'name':'Poetry in Motion  SW Edition', 'link':'/mosaic/3301', 'city':'Eden Prairie'});
	currentArray.append({'name':'Poetry in Motion  West Edition', 'link':'/mosaic/3302', 'city':'Minneapolis'});
	currentArray.append({'name':'Eagan Banner', 'link':'/mosaic/3303', 'city':'Saint Paul'});
	currentArray.append({'name':'Uptown Minneapolis', 'link':'/mosaic/3311', 'city':'Minneapolis'});
	currentArray.append({'name':'Bemidji Badge Series', 'link':'/mosaic/3327', 'city':'Bemidji'});
	currentArray.append({'name':'Austin Explorer s Club', 'link':'/mosaic/3340', 'city':'Austin'});
	currentArray.append({'name':'Minnesota Zoo', 'link':'/mosaic/5988', 'city':'Saint Paul'});
	currentArray.append({'name':'University Ave', 'link':'/mosaic/8600', 'city':'Saint Paul'});
	currentArray.append({'name':'Apple Peel', 'link':'/mosaic/9673', 'city':'Saint Paul'});
	currentArray.append({'name':'AHS Walk for Nyan Cat', 'link':'/mosaic/9674', 'city':'Minneapolis'});
	currentArray.append({'name':'The Bio-Exorcist of Resurrection Cemetery', 'link':'/mosaic/9907', 'city':'Saint Paul'});
	currentArray.append({'name':'Aegis Nova Banner', 'link':'/mosaic/10729', 'city':'Saint Paul'});
	currentArray.append({'name':'Fulton Neighborhood', 'link':'/mosaic/11187', 'city':'Minneapolis'});
	currentArray.append({'name':'Welcome To Jordan', 'link':'/mosaic/11188', 'city':'Jordan'});
	currentArray.append({'name':'44th  amp  France', 'link':'/mosaic/12118', 'city':'Minneapolis'});
	currentArray.append({'name':'Bonus Fantasy Fun', 'link':'/mosaic/12446', 'city':'Saint Paul'});
	currentArray.append({'name':'Waseca Railway', 'link':'/mosaic/12447', 'city':'Waseca'});
	currentArray.append({'name':'Lakewood Cemetery', 'link':'/mosaic/13205', 'city':'Minneapolis'});
	currentArray.append({'name':'lake superior zoo', 'link':'/mosaic/13364', 'city':'Duluth'});
	currentArray.append({'name':'Exploring Calhoun', 'link':'/mosaic/13941', 'city':'Minneapolis'});
	currentArray.append({'name':'Churches #MissionsForGood', 'link':'/mosaic/17529', 'city':'Chaska'});
	currentArray.append({'name':'Winona', 'link':'/mosaic/17542', 'city':'Winona'});
	currentArray.append({'name':'Explore St  Joseph', 'link':'/mosaic/18876', 'city':'Saint Joseph'});
	currentArray.append({'name':'Spell CHASKA', 'link':'/mosaic/19475', 'city':'Chaska'});
