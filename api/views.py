...
def data_getOpportunities(request):
	...
	currentArray.append({'name':'No Evil  USA', 'link':'/mosaic/3647', 'city':'New York'});
	currentArray.append({'name':'BRG NY', 'link':'/mosaic/3689', 'city':'New York'});
	currentArray.append({'name':'Woodlawn Cemetery 3', 'link':'/mosaic/3690', 'city':'New York'});
	currentArray.append({'name':'LIC NY', 'link':'/mosaic/3698', 'city':'New York'});
	currentArray.append({'name':'Bayridge life', 'link':'/mosaic/3860', 'city':'New York'});
	currentArray.append({'name':'I Love NY', 'link':'/mosaic/3878', 'city':'New York'});
	currentArray.append({'name':'Avenue J', 'link':'/mosaic/6640', 'city':'New York'});
	currentArray.append({'name':'NYCC 2015 Part 1 of 3', 'link':'/mosaic/8382', 'city':'New York'});
	currentArray.append({'name':'Brooklyn Heights Promenade', 'link':'/mosaic/8854', 'city':'New York'});
	currentArray.append({'name':'Hell s Kitchen', 'link':'/mosaic/9188', 'city':'New York'});
	currentArray.append({'name':'Just Invader NYC Scavenger Hunt', 'link':'/mosaic/11509', 'city':'New York'});
	currentArray.append({'name':'NYC Represent', 'link':'/mosaic/12036', 'city':'New York'});
	currentArray.append({'name':'Church at Mount Loretto', 'link':'/mosaic/12548', 'city':'New York'});
	currentArray.append({'name':'History of Lake Ronkonkoma', 'link':'/mosaic/18905', 'city':'Ronkonkoma'});
	currentArray.append({'name':'Harlem River Park  Tower', 'link':'/mosaic/10771', 'city':'New York'});
	currentArray.append({'name':'Level in Oswego', 'link':'/mosaic/19083', 'city':'Oswego'});
	currentArray.append({'name':'Elements  - Watertown', 'link':'/mosaic/19334', 'city':'Watertown'});
	currentArray.append({'name':'Four Corners - Delmar', 'link':'/mosaic/19450', 'city':'Delmar'});
	currentArray.append({'name':'Untermyer Park', 'link':'/mosaic/21916', 'city':'Yonkers'});
	currentArray.append({'name':'3RD and 4TH Avenue Fun', 'link':'/mosaic/22304', 'city':'New York'});
	currentArray.append({'name':'Queens Level Up Farm', 'link':'/mosaic/3699', 'city':'New York'});
	currentArray.append({'name':'The Five Skulls of Clayton NY', 'link':'/mosaic/7050', 'city':'Clayton'});
	currentArray.append({'name':'Sayville Sweep', 'link':'/mosaic/10883', 'city':'Sayville'});
	currentArray.append({'name':'Connect the Dots Rochester', 'link':'/mosaic/19590', 'city':'Rochester'});
	currentArray.append({'name':'Exploring the Capital District', 'link':'/mosaic/20299', 'city':'Albany'});
	currentArray.append({'name':'Tableflip', 'link':'/mosaic/20300', 'city':'Albany'});
	currentArray.append({'name':'Oneonta Detective', 'link':'/mosaic/20916', 'city':'Oneonta'});
	currentArray.append({'name':'Tiger Stripes', 'link':'/mosaic/27171', 'city':'Buffalo'});
	currentArray.append({'name':'Ganandogan Longhouse Banner', 'link':'/mosaic/1119', 'city':'Victor'});
	currentArray.append({'name':'NYC Waterfront', 'link':'/mosaic/1986', 'city':'New York'});
	currentArray.append({'name':'Hudson River Freedom Walk', 'link':'/mosaic/1987', 'city':'New York'});
	currentArray.append({'name':'Yankee Fan Bat', 'link':'/mosaic/1993', 'city':'New York'});
	currentArray.append({'name':'A Mission of Thrash  SLAYER', 'link':'/mosaic/2121', 'city':'New York'});
	currentArray.append({'name':'Montague Street', 'link':'/mosaic/2122', 'city':'New York'});
	currentArray.append({'name':'Cobble Capacitor', 'link':'/mosaic/2124', 'city':'New York'});
	currentArray.append({'name':'QCC RES', 'link':'/mosaic/2342', 'city':'New York'});
	currentArray.append({'name':'SBU Umbilic Torus', 'link':'/mosaic/2523', 'city':'Stony Brook'});
	currentArray.append({'name':'Scary Pandas - Village Halloween Parade 2015', 'link':'/mosaic/2968', 'city':'New York'});
	currentArray.append({'name':'Red Panda Pawse over White Plains', 'link':'/mosaic/3349', 'city':'White Plains'});
	currentArray.append({'name':'Sleepy Hollow Cemetery', 'link':'/mosaic/3350', 'city':'Tarrytown'});
	currentArray.append({'name':'Tappan Zee Bridge', 'link':'/mosaic/3351', 'city':'Irvington'});
	currentArray.append({'name':'Bronxville Lake Mission', 'link':'/mosaic/3352', 'city':'Bronxville'});
	currentArray.append({'name':'Famous Faces', 'link':'/mosaic/3425', 'city':'New York'});
	currentArray.append({'name':'Skull Collection', 'link':'/mosaic/3633', 'city':'New York'});
	currentArray.append({'name':'Cute Robot', 'link':'/mosaic/3635', 'city':'New York'});
	currentArray.append({'name':'Royal Flush', 'link':'/mosaic/3636', 'city':'New York'});
	currentArray.append({'name':'Benches Be Crazy Yo     Central Park', 'link':'/mosaic/3637', 'city':'New York'});
	currentArray.append({'name':'Just Invader Canal St Sewers', 'link':'/mosaic/3642', 'city':'New York'});
	currentArray.append({'name':'Cosmic Pandas', 'link':'/mosaic/3643', 'city':'New York'});
	currentArray.append({'name':'RESIST NY', 'link':'/mosaic/3650', 'city':'New York'});
