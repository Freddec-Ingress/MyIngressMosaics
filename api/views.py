...
def data_getOpportunities(request):
	...
	currentArray.append({'name':'Emerson Church Trek', 'link':'/mosaic/7812', 'city':' Palm Bay'});
	currentArray.append({'name':'Tampa Libraries', 'link':'/mosaic/8661', 'city':' Tampa'});
	currentArray.append({'name':'Samoset Trifecta', 'link':'/mosaic/9002', 'city':' Bradenton'});
	currentArray.append({'name':'Brewery Mission', 'link':'/mosaic/10757', 'city':' Miami'});
	currentArray.append({'name':'Miami Park View', 'link':'/mosaic/12072', 'city':' Miami'});
	currentArray.append({'name':'AXUM WG', 'link':'/mosaic/12426', 'city':' Winter Garden'});
	currentArray.append({'name':'4R  MERICA', 'link':'/mosaic/12531', 'city':' Winter Garden'});
	currentArray.append({'name':'Winter Garden PD', 'link':'/mosaic/12532', 'city':' Winter Garden'});
	currentArray.append({'name':'4R Black', 'link':'/mosaic/12533', 'city':' Winter Garden'});
	currentArray.append({'name':'DTWG Mini', 'link':'/mosaic/12534', 'city':' Winter Garden'});
	currentArray.append({'name':'Grand Prix Tampa', 'link':'/mosaic/15216', 'city':' Tampa'});
	currentArray.append({'name':'STP - Doral', 'link':'/mosaic/15815', 'city':' Miami'});
	currentArray.append({'name':'Kinesthesia', 'link':'/mosaic/15883', 'city':' North Port'});
	currentArray.append({'name':'ENL North Port Blvd', 'link':'/mosaic/15884', 'city':' North Port'});
	currentArray.append({'name':'The Mind Control Thesis', 'link':'/mosaic/18823', 'city':' Jacksonville'});
	currentArray.append({'name':'Jax - Ingress Ninja Series', 'link':'/mosaic/18824', 'city':' Jacksonville'});
	currentArray.append({'name':'AXUM CAGANS', 'link':'/mosaic/19472', 'city':' Clermont'});
	currentArray.append({'name':'Lake Idamere Park Nature Trails', 'link':'/mosaic/19655', 'city':' Tavares'});
	currentArray.append({'name':'Fort Lauderdale', 'link':'/mosaic/6617', 'city':' Fort Lauderdale'});
	currentArray.append({'name':'Coral Reef Park', 'link':'/mosaic/10759', 'city':' Miami'});
	currentArray.append({'name':'5th Avenue Naples', 'link':'/mosaic/15710', 'city':' Naples'});
	currentArray.append({'name':'RIP Robin W', 'link':'/mosaic/15788', 'city':' Fort Lauderdale'});
	currentArray.append({'name':'Hacking Route - Myrtle Hill', 'link':'/mosaic/19870', 'city':' Tampa'});
	currentArray.append({'name':'Lake Mirror Missions', 'link':'/mosaic/20242', 'city':' Lakeland'});
	currentArray.append({'name':'Coconut Grove', 'link':'/mosaic/21738', 'city':' Miami'});
	currentArray.append({'name':'FGCU Campus Tour', 'link':'/mosaic/9084', 'city':' Fort Myers'});
	currentArray.append({'name':'Olustee Battlefield Historic State Park', 'link':'/mosaic/19096', 'city':' Sanderson'});
	currentArray.append({'name':'The Best of the West', 'link':'/mosaic/19099', 'city':' Hialeah'});
	currentArray.append({'name':'Ocala', 'link':'/mosaic/22522', 'city':' Ocala'});
	currentArray.append({'name':'Froggy banner mission', 'link':'/mosaic/3097', 'city':' Palm Beach'});
	currentArray.append({'name':'Curlew Hills Skulls', 'link':'/mosaic/3457', 'city':' Palm Harbor'});
	currentArray.append({'name':'Curlew Hills Skulls 2 0', 'link':'/mosaic/3458', 'city':' Palm Harbor'});
	currentArray.append({'name':'Downtown Venice', 'link':'/mosaic/5407', 'city':' Venice'});
	currentArray.append({'name':'Bradenton Riverwalk', 'link':'/mosaic/5863', 'city':' Bradenton'});
	currentArray.append({'name':'Brevard Zoo', 'link':'/mosaic/5864', 'city':' Melbourne'});
	currentArray.append({'name':'Weeki Wachee FL Street Sign Banner', 'link':'/mosaic/6619', 'city':' Brooksville'});
	currentArray.append({'name':'DTD Tour', 'link':'/mosaic/7724', 'city':' Orlando'});
	currentArray.append({'name':'Evergreen Cemetery Ghosts', 'link':'/mosaic/7839', 'city':' Gainesville'});
	currentArray.append({'name':'Tour of Destin', 'link':'/mosaic/8640', 'city':' Destin'});
	currentArray.append({'name':'Bluefire CityWalk Tour', 'link':'/mosaic/8826', 'city':' Orlando'});
	currentArray.append({'name':'Coral Springs District', 'link':'/mosaic/8901', 'city':' Pompano Beach'});
	currentArray.append({'name':'FSU Football', 'link':'/mosaic/9108', 'city':' Tallahassee'});
	currentArray.append({'name':'Hacking Historic Downtown', 'link':'/mosaic/9172', 'city':' Brooksville'});
	currentArray.append({'name':'Okaloosa Island', 'link':'/mosaic/9676', 'city':' Fort Walton Beach'});
	currentArray.append({'name':'A S H', 'link':'/mosaic/9677', 'city':' Miami'});
	currentArray.append({'name':'Saint Andrews State Park Series', 'link':'/mosaic/9760', 'city':' Panama City'});
	currentArray.append({'name':'Jessie Brock', 'link':'/mosaic/9817', 'city':' Winter Garden'});
	currentArray.append({'name':'Cemetery Run', 'link':'/mosaic/10187', 'city':' Bartow'});
	currentArray.append({'name':'Train Tour', 'link':'/mosaic/10290', 'city':' Magic Kingdom Park'});
	currentArray.append({'name':'University of Miami', 'link':'/mosaic/10291', 'city':' Miami'});
	currentArray.append({'name':'A mission for Gator Fans', 'link':'/mosaic/11199', 'city':' Gainesville'});
	currentArray.append({'name':'A Tour of Old Florida Citrus Groves', 'link':'/mosaic/11200', 'city':' Citra'});
	currentArray.append({'name':'The Great GlitterLord of Jacksonville Mural', 'link':'/mosaic/11251', 'city':' Jacksonville'});
	currentArray.append({'name':'Brickell Skyline', 'link':'/mosaic/12124', 'city':' Miami'});
	currentArray.append({'name':'COWG Cityhall', 'link':'/mosaic/12127', 'city':' Winter Garden'});
	currentArray.append({'name':'Blue Angel Mural', 'link':'/mosaic/12621', 'city':' Jacksonville'});
	currentArray.append({'name':'It s a Jungle Out There', 'link':'/mosaic/13045', 'city':' Tampa'});
	currentArray.append({'name':'Lake Lily Park', 'link':'/mosaic/13462', 'city':' Maitland'});
	currentArray.append({'name':'Civil Rights', 'link':'/mosaic/14034', 'city':' St. Augustine'});
	currentArray.append({'name':'FIU Mission Series', 'link':'/mosaic/14082', 'city':' Miami'});
	currentArray.append({'name':'Magic Kingdom Quotes', 'link':'/mosaic/14327', 'city':' Orlando'});
	currentArray.append({'name':'Capture South Venice', 'link':'/mosaic/14721', 'city':' Venice'});
	currentArray.append({'name':'Ybor City Mural Part 2', 'link':'/mosaic/15055', 'city':' Tampa'});
	currentArray.append({'name':'8 Bit Legends - Wynwood Mission', 'link':'/mosaic/15813', 'city':' Miami'});
	currentArray.append({'name':'Fountainbleau Frogs', 'link':'/mosaic/15817', 'city':' Miami'});
	currentArray.append({'name':'Rainbow Springs State Park', 'link':'/mosaic/16255', 'city':' Dunnellon'});
	currentArray.append({'name':'ORLANDO UNITED', 'link':'/mosaic/16665', 'city':' Orlando'});
	currentArray.append({'name':'DisneyWorld Monorail', 'link':'/mosaic/16667', 'city':' Orlando'});
	currentArray.append({'name':'GO RUCK Beer and Gear', 'link':'/mosaic/16837', 'city':' Jacksonville Beach'});
	currentArray.append({'name':'Sanibel Island', 'link':'/mosaic/18230', 'city':' Sanibel'});
	currentArray.append({'name':'Bengal Banner', 'link':'/mosaic/18456', 'city':' Tampa'});
	currentArray.append({'name':'International Buddhist Society', 'link':'/mosaic/18523', 'city':' Fort Lauderdale'});
	currentArray.append({'name':'Annual Passholder Magnet', 'link':'/mosaic/19094', 'city':' Orlando'});
	currentArray.append({'name':'Beautiful Fish Art', 'link':'/mosaic/19133', 'city':' Montverde'});
	currentArray.append({'name':'A Summers Day', 'link':'/mosaic/19137', 'city':' Tampa'});
	currentArray.append({'name':'FS - Winter Garden', 'link':'/mosaic/19325', 'city':' Winter Garden'});
	currentArray.append({'name':'Sunrise and Sunset', 'link':'/mosaic/19602', 'city':' Saint Petersburg'});
	currentArray.append({'name':'Resistance is Futile - Temple Terrace', 'link':'/mosaic/20189', 'city':' Tampa'});
	currentArray.append({'name':'The Final Frontier - Zephyrhills', 'link':'/mosaic/20190', 'city':' Zephyrhills'});
	currentArray.append({'name':'TBE - Undefeated One Year and Counting', 'link':'/mosaic/20215', 'city':' Saint Petersburg'});
	currentArray.append({'name':'Downtown Jax Codes', 'link':'/mosaic/21074', 'city':' Jacksonville'});
	currentArray.append({'name':'FIU Florida International University', 'link':'/mosaic/21739', 'city':' Miami'});
	currentArray.append({'name':'Water of  Enlightenment', 'link':'/mosaic/21833', 'city':' Cape Coral'});
	currentArray.append({'name':'Kissimmee Lakefront Park', 'link':'/mosaic/21929', 'city':' Kissimmee'});
	currentArray.append({'name':'Wind of Enlightenment', 'link':'/mosaic/22030', 'city':' Cape Coral'});
	currentArray.append({'name':'Through the Wormhole', 'link':'/mosaic/22117', 'city':' Dade City'});
	currentArray.append({'name':'Magnus Reawakens  Luminescent Heart ORL  FL', 'link':'/mosaic/22177', 'city':' Orlando'});
	currentArray.append({'name':'Fire of Enlightenment', 'link':'/mosaic/22826', 'city':' Cape Coral'});
	currentArray.append({'name':'Magnus Reawakens  Luminescent Heart Saint Petersburg  Florida', 'link':'/mosaic/22977', 'city':' Saint Petersburg'});
	currentArray.append({'name':'Clermont Waterfront Park', 'link':'/mosaic/23275', 'city':' Clermont'});
	currentArray.append({'name':'Mark IV Monorail Fleet', 'link':'/mosaic/23316', 'city':' Orlando'});
	currentArray.append({'name':'Mark VI Monorail (Advanced)', 'link':'/mosaic/23317', 'city':' Orlando'});
	currentArray.append({'name':'The Voyage Home', 'link':'/mosaic/23603', 'city':' Lutz'});
	currentArray.append({'name':'Cape Christian Crusade', 'link':'/mosaic/23651', 'city':' Cape Coral'});
	currentArray.append({'name':'Earth of Enlightenment', 'link':'/mosaic/23653', 'city':' Cape Coral'});
	currentArray.append({'name':'The Jungles of Dade City', 'link':'/mosaic/24840', 'city':' San Antonio'});
	currentArray.append({'name':'Hack Safely in Safety Harbor', 'link':'/mosaic/26563', 'city':' Safety Harbor'});
	currentArray.append({'name':'Cleveland St', 'link':'/mosaic/26565', 'city':' Clearwater'});
	currentArray.append({'name':'Gem City of the St Johns', 'link':'/mosaic/26615', 'city':' Palatka'});
	currentArray.append({'name':'Heart of Enlightenment', 'link':'/mosaic/26691', 'city':' Cape Coral'});
	currentArray.append({'name':'Capture Beach Street', 'link':'/mosaic/26796', 'city':' Daytona Beach'});
	currentArray.append({'name':'August 2017 Solar Eclipse - Nashville Anomaly Mural Remake', 'link':'/mosaic/27207', 'city':' Lutz'});
	currentArray.append({'name':'COWG Halloween', 'link':'/mosaic/27392', 'city':' Winter Garden'});
	currentArray.append({'name':'Florida State University', 'link':'/mosaic/21665', 'city':' Tallahassee'});
	currentArray.append({'name':'Punta Gorda Tour', 'link':'/mosaic/16873', 'city':' Punta Gorda'});
	currentArray.append({'name':'Memorial Gardens Run', 'link':'/mosaic/19868', 'city':' Panama City'});
	currentArray.append({'name':'Parks and Rec - SP', 'link':'/mosaic/20216', 'city':' Saint Petersburg'});
	currentArray.append({'name':'Lantern Oath Mission', 'link':'/mosaic/15814', 'city':' Miami'});
	currentArray.append({'name':'Tallahassee - Ingress Ninja Series', 'link':'/mosaic/12037', 'city':' Tallahassee'});
	currentArray.append({'name':'Number Game at Water Works Park', 'link':'/mosaic/18936', 'city':' Tampa'});
	currentArray.append({'name':'Count    Ah ah ah', 'link':'/mosaic/19597', 'city':' Lutz'});
