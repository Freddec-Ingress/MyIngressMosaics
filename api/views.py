...
def data_getOpportunities(request):
	...
	currentArray.append({'name':'The Huntington', 'link':'/mosaic/3379', 'city':'San Marino'});
	currentArray.append({'name':'Carquinez Mural', 'link':'/mosaic/3407', 'city':'Martinez'});
	currentArray.append({'name':'Eureka Ca Mission Series', 'link':'/mosaic/3414', 'city':'Eureka'});
	currentArray.append({'name':'The Bixby Bridge', 'link':'/mosaic/3471', 'city':'Carmel-by-the-Sea'});
	currentArray.append({'name':'Yin-Yang', 'link':'/mosaic/3483', 'city':'San Juan Bautista'});
	currentArray.append({'name':'Hawthorne Hornets', 'link':'/mosaic/4249', 'city':'Hawthorne'});
	currentArray.append({'name':'Walking the Walk of Fame', 'link':'/mosaic/4356', 'city':'Los Angeles'});
	currentArray.append({'name':'66 Tour', 'link':'/mosaic/6804', 'city':'Victorville'});
	currentArray.append({'name':'Journey to The historic Cliff House', 'link':'/mosaic/6812', 'city':'San Francisco'});
	currentArray.append({'name':'Old Town Camarillo', 'link':'/mosaic/6838', 'city':'Camarillo'});
	currentArray.append({'name':'Anonymously Through Lynwood - America', 'link':'/mosaic/7019', 'city':'South Gate'});
	currentArray.append({'name':'Ventura Pier', 'link':'/mosaic/7022', 'city':'Ventura'});
	currentArray.append({'name':'MissionDay San Diego', 'link':'/mosaic/12060', 'city':'San Diego'});
	currentArray.append({'name':'San José Grand Voyage I', 'link':'/mosaic/17068', 'city':'San Jose'});
	currentArray.append({'name':'Mission Santa Barbara', 'link':'/mosaic/22068', 'city':'Santa Barbara'});
	currentArray.append({'name':'Team Tricksters', 'link':'/mosaic/23803', 'city':'Los Angeles'});
	currentArray.append({'name':'Aim to misbehave  in San Mateo', 'link':'/mosaic/24704', 'city':'San Mateo'});
	currentArray.append({'name':'Panda Play Time', 'link':'/mosaic/26780', 'city':'Sacramento'});
	currentArray.append({'name':'Ghost of War', 'link':'/mosaic/26859', 'city':'San Leandro'});
	currentArray.append({'name':'SF Muni at 100 #1', 'link':'/mosaic/3369', 'city':'San Francisco'});
	currentArray.append({'name':'Fiat Lux', 'link':'/mosaic/3428', 'city':'Berkeley'});
	currentArray.append({'name':'Folsom Banner', 'link':'/mosaic/3429', 'city':'Folsom'});
	currentArray.append({'name':'Temecula Monopoly', 'link':'/mosaic/3737', 'city':'Temecula'});
	currentArray.append({'name':'Balboa Park s 100th Celebration', 'link':'/mosaic/5845', 'city':'San Diego'});
	currentArray.append({'name':'The Downey D-Bags', 'link':'/mosaic/6790', 'city':'Downey'});
	currentArray.append({'name':'Great Park', 'link':'/mosaic/9764', 'city':'Irvine'});
	currentArray.append({'name':'Summer of Love', 'link':'/mosaic/18519', 'city':'San Francisco'});
	currentArray.append({'name':'Explore North Lake Tahoe', 'link':'/mosaic/18877', 'city':'Tahoe City'});
	currentArray.append({'name':'Help me Obi Wan', 'link':'/mosaic/24076', 'city':'Sonoma'});
	currentArray.append({'name':'Light and Shadows', 'link':'/mosaic/25072', 'city':'Laguna Beach'});
	currentArray.append({'name':'V  is for Vendetta', 'link':'/mosaic/25225', 'city':'Morgan Hill'});
	currentArray.append({'name':'Resist this MTZ', 'link':'/mosaic/3393', 'city':'Martinez'});
	currentArray.append({'name':'Lost Boys of Santa Cruz', 'link':'/mosaic/3447', 'city':'Santa Cruz'});
	currentArray.append({'name':'City of Burbank', 'link':'/mosaic/7720', 'city':'Burbank'});
	currentArray.append({'name':'Party Time on 2nd Street', 'link':'/mosaic/21159', 'city':'Long Beach'});
	currentArray.append({'name':'Actransit Bus Dash', 'link':'/mosaic/23160', 'city':'Berkeley'});
	currentArray.append({'name':'Sacramento Skyline', 'link':'/mosaic/409', 'city':'Sacramento'});
	currentArray.append({'name':'San Jose Ingress United', 'link':'/mosaic/3464', 'city':'San Jose'});
	currentArray.append({'name':'Hack your way to San Diego Enlightment', 'link':'/mosaic/3537', 'city':'San Diego'});
	currentArray.append({'name':'American Presidents', 'link':'/mosaic/3743', 'city':'Anaheim'});
	currentArray.append({'name':'THE KEY', 'link':'/mosaic/3830', 'city':'Rancho Cucamonga'});
	currentArray.append({'name':'Laguna Beach Lifeguard', 'link':'/mosaic/4153', 'city':'Laguna Beach'});
	currentArray.append({'name':'1913 Corona Road Race', 'link':'/mosaic/9239', 'city':'Corona'});
	currentArray.append({'name':'PAC Theater Mural', 'link':'/mosaic/11576', 'city':'Costa Mesa'});
	currentArray.append({'name':'Jedi Smurf', 'link':'/mosaic/13426', 'city':'Norco'});
	currentArray.append({'name':'South County FBT', 'link':'/mosaic/14426', 'city':'Newport Beach'});
	currentArray.append({'name':'UCR Highlanders Mosaic', 'link':'/mosaic/17708', 'city':'Riverside'});
	currentArray.append({'name':'The Lone Ranger', 'link':'/mosaic/347', 'city':'Santa Clarita'});
	currentArray.append({'name':'Glendale Series', 'link':'/mosaic/3382', 'city':'Glendale'});
	currentArray.append({'name':'Surfs up WC', 'link':'/mosaic/12260', 'city':'Walnut Creek'});
	currentArray.append({'name':'Rancho Obi-Wan', 'link':'/mosaic/22968', 'city':'Petaluma'});
	currentArray.append({'name':'San Gabriel Valley', 'link':'/mosaic/3380', 'city':'Alhambra'});
	currentArray.append({'name':'Sacramento Enlightened', 'link':'/mosaic/3462', 'city':'Sacramento'});
	currentArray.append({'name':'Explore DTLA (Union Station)', 'link':'/mosaic/3593', 'city':'Los Angeles'});
	currentArray.append({'name':'Sacramento Resistance', 'link':'/mosaic/3616', 'city':'Sacramento'});
	currentArray.append({'name':'Boyle Heights Examiner', 'link':'/mosaic/4716', 'city':'Los Angeles'});
	currentArray.append({'name':'COBRA Alpha', 'link':'/mosaic/24004', 'city':'San Luis Obispo'});
