...
def adm_compare(request):
	...
	for imcity_obj in imcity_results:
		...
		city_results = City.objects.filter(region__country__name__iexact=imcountry_obj.compare_name, region__name__iexact=imregion_obj.compare_name, title__iexact=imcity_obj.compare_name)
