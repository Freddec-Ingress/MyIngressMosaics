...
angular.module('FrontModule.directives').directive('mosaicVignet', function() {
	...
	return {
		...
		template: '' +
			...
			'	<div class="card-block-bordered f-row f-justify-center f-align-center" style="height:100px; overflow-y:auto;" ng-class="{\'f-align-start scrollbar scrollbar-mini\': mosaic.missions.length > 24}">' +
