 ...
 * License: MIT
 */angular.module("ui.bootstrap", ["ui.bootstrap.dropdown","ui.bootstrap.multiMap","ui.bootstrap.position","ui.bootstrap.modal","ui.bootstrap.stackedMap"]);
...
angular.module('FrontModule.directives').directive('mosaicVignet', function() {
	...
	return {
		...
		template: '' +
			...
			'	<div class="card-block-bordered f-row f-justify-center" style="height:100px; overflow-y:auto;" ng-class="{\'f-align-start scrollbar scrollbar-mini\': mosaic.missions.length > 24, \'f-align-center\': mosaic.missions.length <= 24}">' +
