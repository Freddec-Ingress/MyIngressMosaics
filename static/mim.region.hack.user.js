// ==UserScript==
// @name           IM Region Hacking plugin
// @version        1.0.0
// @include        https://ingressmosaik.com/*/*
// @match          https://ingressmosaik.com/*/*
// @downloadURL    https://www.myingressmosaics.com/static/front/mim.region.hack.user.js
// @grant          none
// ==/UserScript==
...
function init() {
    ...
    var country_name = $('.container-fluid .col-xs-12:nth-child(3)').children('.panel-heading-1').text().trim().split('|')[1].trim();
